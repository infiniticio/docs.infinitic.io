...
If we want to use a custom [PulsarAdmin](https://pulsar.apache.org/api/admin/org/apache/pulsar/client/admin/PulsarAdmin.html) instance, we can instantiate an `PulsarInfiniticAdmin` instance through:
