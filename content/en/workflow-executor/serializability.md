...
- when a [client](/clients/introduction) (or a workflow executor) dispatches a workflow, it serializes parameters before sending them (along with class name and method name)
...
So workflows must follow the same serializability conditions as [tasks](/task-executor/serializability).
