...
* **CloudEvents (beta):** Infinitc now expose its events in [CloudEvents](https://cloudevents.io) json format. This allow users to build their own dashboards, logs, or even add hooks to some specific events.
